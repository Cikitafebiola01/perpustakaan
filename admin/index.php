...
<br> <br>
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah E-BOOK</button>
<br/>
<br/>
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-1">File E-book</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah E-book Baru</h4>
			</div>
